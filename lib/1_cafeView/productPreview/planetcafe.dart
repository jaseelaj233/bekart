...
class viewplanetcafe extends StatefulWidget {
  // viewplanetcafe({super.key, required this.resName});
  const viewplanetcafe({super.key,});



  @override
  State<viewplanetcafe> createState() => _viewplanetcafeState();
}

class _viewplanetcafeState extends State<viewplanetcafe> {
  ...
  void initState() {
    ...
    _streamPaperItems = FirebaseFirestore.instance
        .collection('products')
        .where('category', isEqualTo: 'planet cafe')
        .snapshots();
  }
